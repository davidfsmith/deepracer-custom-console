...
import {
  checkControlled
} from "./chunk-SHTTXLUR.js";
import {
  InternalBox
} from "./chunk-F4YVK7EK.js";
import {
...
function InternalModal(_a) {
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement(PortaledModal, Object.assign({}, rest))
  );
}
            ...
            import_react3.default.createElement(
              ...
              import_react3.default.createElement(
                ...
                import_react3.default.createElement(
                  ...
                  import_react3.default.createElement(
                    InternalHeader,
                    { variant: "h2", __disableActionsWrapping: true, actions: import_react3.default.createElement(InternalButton, { ariaLabel: closeAriaLabel, className: styles_css_default2["dismiss-control"], variant: "modal-dismiss", iconName: "close", formAction: "none", onClick: onCloseButtonClick }) },
                    import_react3.default.createElement("span", { id: headerId, className: styles_css_default2["header--text"] }, header)
                  )
                ),
                import_react3.default.createElement(
                  "div",
                ...
                footer && import_react3.default.createElement("div", { ref: footerRef, className: clsx_m_default(styles_css_default2.footer, footerStuck && styles_css_default2["footer--stuck"]) }, footer)
              )
            )
          )
        )
...
function FlexibleColumnLayout({ columns = 1, minColumnWidth = 0, disableGutters, variant, children }) {
  ...
  return import_react4.default.createElement("div", { ref: containerRef, className: clsx_m_default(styles_css_default3["css-grid"], styles_css_default3[`grid-variant-${variant}`], shouldDisableGutters && [styles_css_default3["grid-no-gutters"]]), style: { gridTemplateColumns: `repeat(${columnCount}, 1fr)` } }, flattenedChildren.map((child, i) => {
    const key2 = child.key;
    return import_react4.default.createElement("div", { key: key2 ? String(key2) : void 0, className: clsx_m_default(styles_css_default3.item, {
...
function GridColumnLayout({ columns, variant, borders, disableGutters, __breakpoint, children }) {
  ...
  return import_react5.default.createElement(internal_default2, { ref, disableGutters: true, gridDefinition: repeat((_a = COLUMN_DEFS[columns]) !== null && _a !== void 0 ? _a : {}, flattenedChildren.length), className: clsx_m_default(styles_css_default4.grid, styles_css_default4[`grid-columns-${columns}`], styles_css_default4[`grid-variant-${variant}`], {
...
function ColumnLayout(_a) {
  ...
  return import_react6.default.createElement("div", Object.assign({}, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default4["column-layout"]), ref: __internalRootRef }), minColumnWidth ? import_react6.default.createElement(FlexibleColumnLayout, { columns, borders, variant, minColumnWidth, disableGutters }, children) : import_react6.default.createElement(GridColumnLayout, { columns, variant, borders, disableGutters, __breakpoint }, children));
}
...
// node_modules/@cloudscape-design/components/radio-group/internal.js
var InternalRadioGroup = import_react8.default.forwardRef((_a, ref) => {
  ...
  return import_react8.default.createElement("div", Object.assign({ role: "radiogroup", "aria-labelledby": ariaLabelledby, "aria-label": ariaLabel, "aria-describedby": ariaDescribedby, "aria-required": ariaRequired, "aria-controls": ariaControls }, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default.root), ref: __internalRootRef }), items && items.map((item, index) => import_react8.default.createElement(radio_button_default, { key: item.value, ref: index === radioButtonRefIndex ? radioButtonRef : void 0, checked: item.value === value, name: name || generatedName, value: item.value, label: item.label, description: item.description, disabled: item.disabled, onChange, controlId: item.controlId })));
});
...
var ModalContentLayout = ({ left, right }) => {
  ...
  if (smallContainer) {
    return import_react9.default.createElement(
      "div",
      { ref },
      left && import_react9.default.createElement("div", null, left),
      right && import_react9.default.createElement("div", { className: clsx_m_default(left && styles_css_default5["second-column-small"]) }, right)
    );
  }
  ...
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      ...
      left && import_react9.default.createElement("div", null, left),
      right && import_react9.default.createElement("div", null, right)
    )
  );
};
var PageSizePreference = ({ title, options, value, onChange }) => {
  ...
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      ...
      import_react9.default.createElement(internal_default4, { className: styles_css_default5["page-size-radio-group"], value: `${value}`, items: options.map(({ label, value: value2 }) => ({ label, value: `${value2}` })), onChange: ({ detail }) => onChange(parseInt(detail.value, 10)) })
    )
  );
};
var WrapLinesPreference = ({ label, description, value, onChange }) => {
  const i18n = useInternalI18n("collection-preferences");
  return import_react9.default.createElement(internal_default3, { checked: !!value, description: i18n("wrapLinesPreference.description", description), onChange: ({ detail }) => onChange(detail.checked), className: styles_css_default5["wrap-lines"] }, i18n("wrapLinesPreference.label", label));
};
function StripedRowsPreference({ label, description, value, onChange }) {
  const i18n = useInternalI18n("collection-preferences");
  return import_react9.default.createElement(internal_default3, { checked: !!value, description: i18n("stripedRowsPreference.description", description), onChange: ({ detail }) => onChange(detail.checked), className: styles_css_default5["striped-rows"] }, i18n("stripedRowsPreference.label", label));
}
var ContentDensityPreference = ({ label, description, value, onChange }) => {
  const i18n = useInternalI18n("collection-preferences");
  return import_react9.default.createElement(internal_default3, { checked: value === "compact", description: i18n("contentDensityPreference.description", description), onChange: ({ detail }) => onChange(detail.checked ? "compact" : "comfortable"), className: styles_css_default5["content-density"] }, i18n("contentDensityPreference.label", label));
};
var StickyPreference = ({ firstOrLast, preference, value, onChange }) => {
  ...
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      ...
      import_react9.default.createElement(internal_default4, { className: styles_css_default5["sticky-columns-radio-group"], value: typeof value !== "undefined" ? `${value}` : null, items: options.map(({ label, value: value2 }) => ({ label, value: `${value2}` })), onChange: ({ detail }) => onChange(Number(detail.value)) })
    )
  );
};
var StickyColumnsPreference = ({ firstColumns, lastColumns, onChange, value }) => {
  return import_react9.default.createElement(
    ...
    firstColumns && import_react9.default.createElement(StickyPreference, { firstOrLast: "first", preference: firstColumns, value: value === null || value === void 0 ? void 0 : value.first, onChange: (newValue) => onChange(Object.assign(Object.assign({}, value), { first: newValue })) }),
    lastColumns && import_react9.default.createElement(StickyPreference, { firstOrLast: "last", preference: lastColumns, value: value === null || value === void 0 ? void 0 : value.last, onChange: (newValue) => onChange(Object.assign(Object.assign({}, value), { last: newValue })) })
  );
};
var CustomPreference = ({ value, customPreference, onChange }) => {
  const [customState, setCustomState] = (0, import_react9.useState)(value);
  if (customPreference) {
    return import_react9.default.createElement("div", { className: styles_css_default5.custom }, customPreference(customState, (value2) => {
...
// node_modules/@cloudscape-design/components/toggle/internal.js
var InternalToggle = import_react10.default.forwardRef((_a, ref) => {
  ...
  const baseProps = getBaseProps(rest);
  const checkboxRef = (0, import_react10.useRef)(null);
  useForwardFocus(ref, checkboxRef);
  return import_react10.default.createElement(AbstractSwitch, Object.assign({}, baseProps, { className: clsx_m_default(styles_css_default6.root, baseProps.className), controlClassName: clsx_m_default(styles_css_default6["toggle-control"], {
    [styles_css_default6["toggle-control-checked"]]: checked,
    [styles_css_default6["toggle-control-disabled"]]: disabled
  }), outlineClassName: styles_css_default6.outline, controlId, disabled, label: children, description, descriptionBottomPadding: true, ariaLabel, ariaLabelledby, ariaDescribedby, ariaControls, nativeControl: (nativeControlProps) => import_react10.default.createElement("input", Object.assign({}, nativeControlProps, {
    ref: checkboxRef,
    type: "checkbox",
    checked,
    name,
    ...
    import_react10.default.createElement("span", { className: clsx_m_default(styles_css_default6["toggle-handle"], {
...
function VisibleContentPreference({ title, options, value = [], onChange }) {
  ...
  const selectionOption = (option, optionGroupIndex, optionIndex) => {
    ...
    return import_react11.default.createElement(
      ...
      import_react11.default.createElement("label", Object.assign({}, className("option-label"), { htmlFor: labelId }), option.label),
      import_react11.default.createElement(
        "div",
        Object.assign({}, className("toggle")),
        import_react11.default.createElement(internal_default5, { checked: isVisible(option.id, value), onChange: () => onToggle(option.id), disabled: option.editable === false, controlId: labelId })
      )
    );
  };
  ...
  return import_react11.default.createElement(
    ...
    import_react11.default.createElement("h3", Object.assign({}, className("title"), { id: outerGroupLabelId }), title),
    import_react11.default.createElement(InternalSpaceBetween, Object.assign({}, className("groups"), { size: "xs" }), options.map((optionGroup, optionGroupIndex) => {
      ...
      return import_react11.default.createElement(
        ...
        import_react11.default.createElement("div", Object.assign({}, className("group-label"), { id: groupLabelId }), optionGroup.label),
        import_react11.default.createElement("div", null, optionGroup.options.map((option, optionIndex) => selectionOption(option, optionGroupIndex, optionIndex)))
      );
    }))
  );
}
...
function useRect(element, measure, fallbackRect) {
  ...
  const [rect, measureRect] = (0, import_react14.useReducer)(reducer2, null);
...
function useRects(elements, measure) {
  ...
  const [rects, measureRects] = (0, import_react14.useReducer)(reducer2, defaultValue$2);
  const resizeObserver = useResizeObserver({
...
function Handle(props) {
  return import_react16.default.createElement("div", Object.assign({ role: "button", tabIndex: 0 }, props, { onPointerDown: props.onPointerDown, className: clsx_m_default(styles_css_default7.handle, props.className) }));
}
...
function DragHandle({ attributes, hideFocus, listeners }) {
  return import_react17.default.createElement(
    ...
    import_react17.default.createElement(internal_default, { name: "drag-indicator" })
  );
}
...
var ContentDisplayOption = (0, import_react18.forwardRef)(({ dragHandleAriaLabel, listeners, onToggle, option }, ref) => {
  ...
  return import_react18.default.createElement(
    ...
    import_react18.default.createElement(DragHandle, { attributes: dragHandleAttributes, listeners }),
    import_react18.default.createElement("label", { className: getClassName("label"), htmlFor: controlId }, option.label),
    import_react18.default.createElement(
      "div",
      { className: getClassName("toggle") },
      import_react18.default.createElement(internal_default5, { checked: !!option.visible, onChange: () => onToggle && onToggle(option), disabled: option.alwaysVisible === true, controlId })
    )
  );
});
...
function DraggableOption({ dragHandleAriaLabel, onKeyDown, onToggle, option }) {
  ...
  return import_react19.default.createElement(
    ...
    import_react19.default.createElement(content_display_option_default, { ref: setNodeRef, listeners: combinedListeners, dragHandleAriaLabel, onToggle, option })
  );
}
...
function useDragAndDropReorder({ sortedOptions }) {
  const isKeyboard = (0, import_react20.useRef)(false);
  const positionDelta = (0, import_react20.useRef)(0);
  const [activeItemId, setActiveItemId] = (0, import_react20.useState)(null);
...
function useLiveAnnouncements({ isDragging, liveAnnouncementDndStarted, liveAnnouncementDndItemReordered, liveAnnouncementDndItemCommitted, liveAnnouncementDndDiscarded, sortedOptions }) {
  const isFirstAnnouncement = (0, import_react21.useRef)(true);
  if (!isDragging) {
...
function ContentDisplayPreference({ title, description, options, value = options.map(({ id }) => ({
  ...
  return import_react22.default.createElement(
    ...
    import_react22.default.createElement("h3", { className: getClassName2("title"), id: titleId }, i18n("contentDisplayPreference.title", title)),
    import_react22.default.createElement("p", { className: getClassName2("description"), id: descriptionId }, i18n("contentDisplayPreference.description", description)),
    import_react22.default.createElement(
      ...
      import_react22.default.createElement(
        ...
        import_react22.default.createElement(SortableContext, { items: sortedOptions.map(({ id }) => id), strategy: verticalListSortingStrategy }, sortedOptions.map((option) => {
          return import_react22.default.createElement(DraggableOption, { dragHandleAriaLabel: i18n("contentDisplayPreference.dragHandleAriaLabel", dragHandleAriaLabel), key: option.id, onKeyDown: handleKeyDown, onToggle, option });
        }))
      ),
      import_react22.default.createElement(
        Portal,
        null,
        import_react22.default.createElement(DragOverlay, { className: styles_css_default5["drag-overlay"], dropAnimation: null, style: { zIndex: 5e3 } }, activeOption && import_react22.default.createElement(content_display_option_default, { listeners: { onKeyDown: handleKeyDown }, dragHandleAriaLabel: i18n("contentDisplayPreference.dragHandleAriaLabel", dragHandleAriaLabel), onToggle, option: activeOption }))
      )
    )
  );
}
...
function CollectionPreferences(_a) {
  ...
  const [temporaryPreferences, setTemporaryPreferences] = (0, import_react23.useState)(copyPreferences(preferences || {}));
  const triggerRef = (0, import_react23.useRef)(null);
  const dialogPreviouslyOpen = (0, import_react23.useRef)(false);
  ...
  return import_react23.default.createElement(
    ...
    import_react23.default.createElement(InternalButton, { ref: triggerRef, className: styles_css_default5["trigger-button"], disabled, ariaLabel: i18n("title", title), onClick: () => {
      setTemporaryPreferences(copyPreferences(preferences || {}));
      setModalVisible(true);
    }, variant: "icon", iconName: "settings", formAction: "none" }),
    !disabled && modalVisible && import_react23.default.createElement(
      InternalModal,
      { className: styles_css_default5["modal-root"], visible: true, getModalRoot, removeModalRoot, header: i18n("title", title), footer: import_react23.default.createElement(
        InternalBox,
        { float: "right" },
        import_react23.default.createElement(
          InternalSpaceBetween,
          { direction: "horizontal", size: "xs" },
          import_react23.default.createElement(InternalButton, { className: styles_css_default5["cancel-button"], variant: "link", formAction: "none", onClick: onCancelListener }, i18n("cancelLabel", cancelLabel)),
          import_react23.default.createElement(InternalButton, { className: styles_css_default5["confirm-button"], variant: "primary", formAction: "none", onClick: onConfirmListener }, i18n("confirmLabel", confirmLabel))
        )
      ), closeAriaLabel: cancelLabel, size: hasContentOnTheLeft && hasContentOnTheRight ? "large" : "medium", onDismiss: onCancelListener },
      import_react23.default.createElement(ModalContentLayout, { left: hasContentOnTheLeft && import_react23.default.createElement(
        InternalSpaceBetween,
        { size: "l" },
        pageSizePreference && import_react23.default.createElement(PageSizePreference, Object.assign({ value: temporaryPreferences.pageSize }, pageSizePreference, { onChange: (pageSize) => onChange({ pageSize }) })),
        wrapLinesPreference && import_react23.default.createElement(WrapLinesPreference, Object.assign({ value: temporaryPreferences.wrapLines }, wrapLinesPreference, { onChange: (wrapLines) => onChange({ wrapLines }) })),
        stripedRowsPreference && import_react23.default.createElement(StripedRowsPreference, Object.assign({ value: temporaryPreferences.stripedRows }, stripedRowsPreference, { onChange: (stripedRows) => onChange({ stripedRows }) })),
        contentDensityPreference && import_react23.default.createElement(ContentDensityPreference, Object.assign({ value: temporaryPreferences.contentDensity }, contentDensityPreference, { onChange: (contentDensity) => onChange({ contentDensity }) })),
        stickyColumnsPreference && import_react23.default.createElement(StickyColumnsPreference, Object.assign({ value: temporaryPreferences.stickyColumns }, stickyColumnsPreference, { onChange: (stickyColumns) => onChange({ stickyColumns }) })),
        customPreference && import_react23.default.createElement(CustomPreference, { value: temporaryPreferences.custom, customPreference, onChange: (custom) => onChange({ custom }) })
      ), right: contentDisplayPreference ? import_react23.default.createElement(ContentDisplayPreference, Object.assign({}, contentDisplayPreference, { value: temporaryPreferences.contentDisplay, onChange: (contentDisplay) => onChange({ contentDisplay }) })) : visibleContentPreference && import_react23.default.createElement(VisibleContentPreference, Object.assign({ value: temporaryPreferences.visibleContent }, visibleContentPreference, { onChange: (visibleItems) => onChange({ visibleContent: visibleItems }) })) })
    )
  );
}
...
//# sourceMappingURL=chunk-6KI6MNLX.js.map
