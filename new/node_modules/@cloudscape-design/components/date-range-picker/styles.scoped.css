...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_calendar_mgja0_1osv1_153:not(#\9) {
  animation: awsui_awsui-motion-fade-in-0_mgja0_1osv1_1 var(--motion-duration-show-quick-aq3ump, 135ms) var(--motion-easing-show-quick-vc5zgd, ease-out);
  animation-fill-mode: both;
}
@keyframes awsui_awsui-motion-fade-in-0_mgja0_1osv1_1 {
  from {
    opacity: 0;
  }
  to {
...
.awsui-motion-disabled .awsui_calendar_mgja0_1osv1_153:not(#\9), .awsui-mode-entering .awsui_calendar_mgja0_1osv1_153:not(#\9) {
  animation: none;
  transition: none;
}

.awsui_root_mgja0_1osv1_176:not(#\9) {
...
.awsui_root_mgja0_1osv1_176:not(#\9):not(.awsui_wide_mgja0_1osv1_207) {
  max-inline-size: 32em;
}
.awsui_root_mgja0_1osv1_176.awsui_wide_mgja0_1osv1_207:not(#\9) {
  max-inline-size: 39em;
}

.awsui_focus-lock_mgja0_1osv1_214:not(#\9) {
  display: contents;
}

.awsui_trigger-flexbox_mgja0_1osv1_218:not(#\9) {
  display: flex;
}

.awsui_calendar-container_mgja0_1osv1_222:not(#\9) {
  inline-size: calc(2 * var(--size-calendar-grid-width-lrunz7, 238px) + var(--space-xs-zb16t3, 8px));
}
.awsui_calendar-container_mgja0_1osv1_222.awsui_one-grid_mgja0_1osv1_225:not(#\9) {
  inline-size: var(--size-calendar-grid-width-lrunz7, 238px);
}

.awsui_calendar-header_mgja0_1osv1_229:not(#\9) {
  display: flex;
  justify-content: space-between;
  align-items: center;
  position: relative;
}
.awsui_calendar-header-months-wrapper_mgja0_1osv1_235:not(#\9) {
  position: absolute;
  inset: 0;
  margin-block: 0;
  margin-inline: 0;
...
.awsui_calendar-header-month_mgja0_1osv1_235:not(#\9) {
  font-size: var(--font-size-body-m-x4okxb, 14px);
  line-height: var(--line-height-body-m-30ar75, 20px);
  font-weight: 700;
  color: var(--color-text-body-default-7v1jfn, #0f141a);
...
.awsui_first-grid_mgja0_1osv1_261:not(#\9),
...
.awsui_date-and-time-wrapper_mgja0_1osv1_272:not(#\9) {
  inline-size: var(--size-calendar-grid-width-lrunz7, 238px);
  display: grid;
  gap: var(--space-xs-zb16t3, 8px);
...
.awsui_footer_mgja0_1osv1_279:not(#\9) {
  display: flex;
  flex-wrap: wrap;
...
.awsui_footer_mgja0_1osv1_279.awsui_has-clear-button_mgja0_1osv1_288:not(#\9) {
  justify-content: space-between;
}
.awsui_footer_mgja0_1osv1_279.awsui_one-grid_mgja0_1osv1_225:not(#\9) {
  padding-block-start: 0;
  padding-block-end: var(--space-s-34lx8l, 12px);
  padding-inline: var(--space-xs-zb16t3, 8px);
}

.awsui_footer-button-wrapper_mgja0_1osv1_297:not(#\9) {
  padding-block-start: var(--space-s-34lx8l, 12px);
}
.awsui_footer-button-wrapper_mgja0_1osv1_297:not(#\9):last-child {
  margin-inline-start: auto;
}

.awsui_icon-wrapper_mgja0_1osv1_304:not(#\9) {
  color: var(--color-text-interactive-default-tkx8fe, #424650);
  margin-inline-end: var(--space-xs-zb16t3, 8px);
}

.awsui_label_mgja0_1osv1_309:not(#\9) {
  cursor: default;
}

.awsui_label_mgja0_1osv1_309.awsui_label-enabled_mgja0_1osv1_313:not(#\9):hover > .awsui_trigger-flexbox_mgja0_1osv1_218 > .awsui_icon-wrapper_mgja0_1osv1_304 {
  color: var(--color-text-interactive-hover-f9gqs8, #0f141a);
}

.awsui_label-text_mgja0_1osv1_317:not(#\9) {
  color: var(--color-text-input-placeholder-f3x213, #656871);
  font-style: italic;
}

.awsui_label-token-nowrap_mgja0_1osv1_322:not(#\9) {
  white-space: nowrap;
}

.awsui_mode-switch_mgja0_1osv1_326:not(#\9) {
  /* used in test-utils */
}
...
.awsui_dropdown_mgja0_1osv1_330:not(#\9):focus {
  outline: none;
}
body[data-awsui-focus-visible=true] .awsui_dropdown_mgja0_1osv1_330:not(#\9):focus {
...
.awsui_dropdown-content_mgja0_1osv1_352:not(#\9) {
...
.awsui_dropdown-content_mgja0_1osv1_352.awsui_one-grid_mgja0_1osv1_225:not(#\9) {
